...
from application.api.claims.schemas import CreateClaimRequestSchema, CreateClaimResponseSchema
...
async def create_claim_handler(
    ...
    try:
        claim, *_ = await mediator.handle_command(CreateClaimCommand(title=schema.title, 
